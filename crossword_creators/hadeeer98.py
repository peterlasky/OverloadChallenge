...
class CrosswordCreator():
    ...
    def assignment_complete(self, assignment): ## WORKS!!!
        """
    ...
    def consistent(self, assignment): ## Works
        """
    ...
    def order_domain_values(self, var, assignment): ## WORKS
        """
    ...
    def select_unassigned_variable(self, assignment): ## Works
        """
